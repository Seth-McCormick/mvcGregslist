              ...
              <h3> List a Car </h3>
                <div class="row">
                  ...
                  <div class="col-3 mb-2">
                    ...
                    <input required type="number" name="year" id="year" value="${car.year || ''}" min="1960" max="2023"
                      class="form-control" placeholder="" aria-describedby="helpId">
                  </div>
                  <div class="col-3 mb-2">
                  ...
                  <div class="col-6">
                    ...
                    <input required type="color" name="color" id="color" value="${car.color || ''}" class="form-control" placeholder=""
                      aria-describedby="helpId">
                  </div>
                </div>
...
function getButtons(id) {
  ...
  if (id) {
    return `
<button type="submit" class="btn btn-primary px-3 py-2" title="Edit a car"><i
